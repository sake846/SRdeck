...
public static class SizeObserver
{
    ...
    private static void OnObserveChanged(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs eventArgs)
    {
        if (dependencyObject is FrameworkElement frameworkElement)
        {
            if ((bool)eventArgs.NewValue)
            {
                ...
                SyncObservedSizesForFrameworkElement(frameworkElement);
            }
            else
            {
                frameworkElement.SizeChanged -= OnFrameworkElementSizeChanged;
    ...
    private static void OnFrameworkElementSizeChanged(object sender, SizeChangedEventArgs eventArgs)
    {
    ...
    private static void SyncObservedSizesForFrameworkElement(FrameworkElement frameworkElement)
    {
